...
import {
  ...
  type TitleFieldPropertiesSchemaType,
} from '@/shared/schemas/forms/fields/title-field.schema';
...
function PropertiesComponent({ element }: { element: FormElementInstance }) {
  ...
  const form = useForm<TitleFieldPropertiesSchemaType>({
  ...
  const applyChanges = (data: TitleFieldPropertiesSchemaType) => {
